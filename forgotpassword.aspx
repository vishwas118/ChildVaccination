...
<body>
                ...
                <div class="bg-light rounded p-5">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <asp:TextBox ID="Fologinemail" placeholder="Email Address" CssClass="form-control Fologinemail"
                                runat="server"></asp:TextBox>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <asp:TextBox ID="Fologinpass" placeholder="Password" CssClass="form-control Fologinpass" runat="server"
                                TextMode="Password"></asp:TextBox>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <asp:TextBox ID="Fologinpassconfirm" placeholder="Confirm Password" CssClass="form-control Fologinpassconfirm" runat="server" TextMode="Password"></asp:TextBox>
                        </div>
                        <div class="col-12">
                            <asp:Button ID="btnRegister" Text="Submit" CssClass="btn btn-primary w-100 py-3"
                                OnClientClick="return ValidationOnSaveForgot();" OnClick="btnforgot_Click" runat="server" />
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function ValidationOnSaveForgot() {
            var Alert = ""
            $(".Mandatory").removeClass("error");

            if (!$(".Fologinemail").val()) {
                $(".Fologinemail").addClass("error");
                Alert += "Please Enter Email.\n";
            }
            else {
                if (!ValidateEmail($(".Fologinemail").val())) {
                    Alert += "Please Enter Valid Email ID.\n";
                }
            }

            if ($(".Fologinpass").val() && $(".Fologinpassconfirm").val() && $(".Fologinpass").val() != $(".Fologinpassconfirm").val()) {
                $(".Fologinpass, .Fologinpassconfirm").addClass("error");
                Alert += "Password & Confirm Password does not match.\n";
            }
            if (!$(".Fologinpass").val()) {
                $(".Fologinpass").addClass("error");
                Alert += "Please Enter Password.\n";
            }
            if (!$(".Fologinpassconfirm").val()) {
                $(".Fologinpassconfirm").addClass("error");
