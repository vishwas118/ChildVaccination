    ...
    <div class="container-fluid position-relative p-0">
        ...
        <div class="container-fluid py-5 bg-header">
            <div class="row py-5 text-center">
                <h1 class="display-4 text-white animated zoomIn">forgot paasword</h1>
            </div>
        </div>
    </div>
    <!-- Navbar End -->
            ...
            <div class="col-lg-6 m-auto">                      
                ...
                <div class="bg-light rounded p-5">
                    <div class="section-title section-title-sm position-relative pb-3 mb-4">
                        <h3 class="mb-0">forgot paasword</h3>
                    </div>
                    <form>
                        <div class="row g-3">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <input type="email" class="form-control" placeholder="Email Address" style="height: 45px;"  required>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <input type="password" class="form-control" placeholder="New Password" style="height: 45px;"  required>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <input type="password" class="form-control" placeholder="Confirm Password" style="height: 45px;"  required>
                            </div>
                            <div class="col-12">
                                <button class="btn btn-primary w-100 py-3" type="submit">Go to login</button>
                            </div>
                        </div>
