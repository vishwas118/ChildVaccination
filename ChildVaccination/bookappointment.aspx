            ...
            <div class="col-lg-9 m-auto">                      
                ...
                <div class="bg-light rounded p-5">
                    <div class="section-title section-title-sm position-relative pb-3 mb-4">
                        <h3 class="mb-0">Book an Appoiment</h3>
                    </div>
                    <form>
                        <div class="row g-3">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <input type="text" class="form-control" placeholder="First Name" style="height: 45px;" required>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <input type="text" class="form-control" placeholder="Last Name" style="height: 45px;"  required>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <input type="email" class="form-control" placeholder="Email" style="height: 45px;"  required>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <input type="tel" class="form-control" placeholder="Phone Number" style="height: 45px;"  required>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <input type="date" class="form-control" placeholder="DOB" style="height: 45px;"  required>
                            </div>
