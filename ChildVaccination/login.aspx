                    ...
                    <form runat="server">
                        <div class="row g-3">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <%--<input type="email" class="form-control" placeholder="Emil Address" style="height: 45px;"  required>--%>
                                <asp:TextBox ID="loginemail" placeholder="Email Address" CssClass="form-control"
                                runat="server"></asp:TextBox>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12">
                               <%-- <input type="password" class="form-control" placeholder="Password" style="height: 45px;"  required>--%>
                                <asp:TextBox ID="loginpass" placeholder="Password" CssClass="form-control"     runat="server" TextMode="Password"></asp:TextBox>
                            </div>
                            <div class="col-12">
                               <%-- <button class="btn btn-primary w-100 py-3" type="button" onclick="btnLogin_Click">Login</button>--%>
                                <asp:Button ID="btnRegister" Text="Register Now" CssClass="btn btn-primary w-100 py-3" OnClick="btnLogin_Click" runat="server" />
                            </div>
                        </div>
                        <p class="text-center my-3 mb-0">Don't have an account? <a href="register.aspx" class="text-primary">Register Here</a></p>
                        <p class="text-center my-3 mb-0">Forgot Password ? <a href="forgotpassword.aspx" class="text-primary">Forgot Password</a>
                    </form>
                </div>
                <!-- Comment Form End -->
            </div>
