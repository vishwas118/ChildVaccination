...
<body>
            ...
            <div class="row g-5 mb-5">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="d-flex align-items-center wow fadeIn mb-5" data-wow-delay="0.4s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">
                                Email to get free quote</h5>
                            <h6 class="text-primary mb-0">
                                adhyahospital11@gmail.com</h6>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <div class="bg-primary rounded h-100 d-flex align-items-center p-5 wow zoomIn" data-wow-delay="0.9s">
                        ...
                        <div class="row g-3">
                            <div class="col-xl-12">
                                <asp:TextBox ID="txtConame" placeholder="Your Name" CssClass="form-control txtConame h-45 Mandatory"
                            ...
                            <div class="col-12">
                                ...
                                <asp:TextBox ID="txtCoEmail" placeholder="Your Email" CssClass="form-control txtCoEmail h-45 Mandatory"
                                    runat="server"></asp:TextBox>
                            </div>
                            <div class="col-12">
                                <%--<input type="tel" class="form-control" placeholder="Phone Number" style="height: 45px;"
                                    required>--%>
                                <asp:TextBox ID="txtCoPhoneNo" placeholder="Phone Number" CssClass="form-control txtCoPhoneNo h-45 Mandatory"
                                    runat="server" onkeyup="AllowOnlyNumberCo(this);" MaxLength="10"></asp:TextBox>
                            </div>
                            <div class="col-12">
                            <asp:TextBox ID="txtCoAddress" placeholder="Message" CssClass="form-control txtCoAddress h-45 Mandatory"
                                    runat="server"></asp:TextBox>
                                <%--<textarea class="form-control" rows="3" placeholder="Message"></textarea>--%>

                            </div>
                            <div class="col-12">
                            <asp:Button ID="btnCoRegister" Text="Requet A Quote" CssClass="btn btn-dark w-100 py-3"
                                OnClientClick="return CoValidationOnSave();" OnClick="btnRegisterCo_Click" runat="server" />
    ...
    <div class="wow slideInUp" data-wow-delay="0.6s">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d117505.14535760552!2d72.49666891338163!3d23.022457990899976!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e869121f6208d%3A0x60c32bf4d2aa9b1d!2sShyam%20Sikhar%20Complex!5e0!3m2!1sen!2sin!4v1683022696214!5m2!1sen!2sin"
    ...
    <script type="text/javascript">
        function AllowOnlyNumberCo(self) {
        ...
        function CoValidationOnSave() {
        debugger
            var Alert = ""
            $(".Mandatory").removeClass("error");
            if (!$(".txtConame").val()) {
                $(".txtConame").addClass("error");
                Alert += "Please Enter Full Name.\n";
            }

            if (!$(".txtCoEmail").val()) {
                $(".txtCoEmail").addClass("error");
                Alert += "Please Enter Email.\n";
            }
            else {
                if (!ValidateEmail($(".txtCoEmail").val())) {
                    Alert += "Please Enter Valid Email ID.\n";
                }
            }

            if (!$(".txtCoPhoneNo").val()) {
                $(".txtCoPhoneNo").addClass("error");
